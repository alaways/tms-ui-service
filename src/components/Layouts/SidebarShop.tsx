        ...
        <div className="bg-white dark:bg-black h-full">
          <div className="flex justify-between items-center px-4 py-3">
            <NavLink to="/" className="main-logo flex items-center shrink-0">
              <img className={"w-26 h-16 ml-[35px] flex-none"} src={themeInit.logo.ShopLogo} alt="logo" />
            </NavLink>
          ...
          <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
            <ul className="relative space-y-0.5 p-4 py-0">
              ...
              <li className="nav-item">
                <NavLink to="/apps/shop/detail" className={currentSubMenu === '/apps/shop/detail' ? 'group active' : 'group'}>
                  <div className="flex items-center">
