        ...
        <div className="bg-white dark:bg-black h-full">
          <div className="flex justify-between items-center px-4 py-3">
            <NavLink to="/" className="main-logo flex items-center shrink-0">
              <img className="w-26 h-16 ml-[35px] flex-none" src={themeInit.logo.BussinessLogo} alt="logo" />
            </NavLink>
                  ...
                  <li className="menu nav-item">
                    ...
                    <AnimateHeight duration={300} height={currentMenu === 'finance' ? 'auto' : 0}>
                      <ul className="sub-menu text-gray-500">
                        ...
                        <li>
                          <NavLink to="/apps/finance/payment/business-unit" className={currentSubMenu === '/apps/finance/payment/business-unit' ? 'active' : ''}>
                            การชำระเงิน
                          </NavLink>
                        </li>
                      </ul>
