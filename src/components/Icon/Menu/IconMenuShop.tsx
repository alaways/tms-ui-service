...
interface IconMenuShopProps {
    className?: string;
}

const IconMenuShop: FC<IconMenuShopProps> = ({ className }) => {
    return (
        <svg fill="none" width="20" height="20" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={className}>
            <g>
                <g>
                    <path d="M76.8,230.4v230.4H256V230.4H76.8z M230.4,435.2h-128V256h128V435.2z" fill="currentColor" opacity="0.5" />
                </g>
            </g>
            <g>
                <g>
