...
const AddV2 = () => {
    ...
    onSuccess: (res: any, variables: any) => {
      if (res.statusCode === 200 || res.code === 200) {
        ...
        if (setFormValue) {
          ...
          if (setFormValue) { variables.props.setValues(setFormValue) }
            ...
            <button
              ...
              onClick={() => {
                if (props.values.citizen_id?.length === 13) {
                  citizenIdSearch({ 
                    data: { 
                      citizen_id: props.values.citizen_id?.toString() 
                    }, props 
                  })
                } else {
                  toast.fire({
  ...
  return (
   <>
    {/* <CameraOCR /> */}
    {isCameraOcr ? <CameraOCR onSubmit={handleCameraSubmit} onClose={() => setIsCameraOcr(false)}/> :   <div className="flex flex-col gap-2.5">
