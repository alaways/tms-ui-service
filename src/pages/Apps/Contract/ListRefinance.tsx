...
const ListRefinance = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle(t('refinance_contract_list')));
    }, [dispatch, t]);
                        ...
                        <Transition.Child as={React.Fragment}>
                            <div className="relative bg-white rounded-lg px-6 pt-5 pb-6 shadow-xl w-full max-w-3xl z-10">
                                ...
                                <div className="mb-4">
                                    ...
                                    <Select options={status} value={selectedStatusCode} onChange={(val) => setSelectedStatusCode(val)} placeholder={t('select_status_placeholder')} />
                                </div>
