const ReceiveProductThankyouPage = () => {
    document.title = "ลงทะเบียนสำเร็จ";
            ...
            <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl text-center transform transition-all p-8 sm:p-12">
                ...
                <div className="space-y-4">
                    <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">
                        บันทึกใบรับสินค้าเรียบร้อย
                    </h1>
                    <p className="text-base text-gray-600 leading-relaxed">
                        ระบบได้บันทึกข้อมูลของท่านเรียบร้อยแล้ว
                        <br />
...
export default ReceiveProductThankyouPage;
